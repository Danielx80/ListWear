...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items.add(new ItemsList(R.drawable.futbol, "Futbol", "Curso de Futbol"));
        items.add(new ItemsList(R.drawable.basquet, "Basquetbol", "Curso de Basquetbol"));
        items.add(new ItemsList(R.drawable.beisbol, "Beisbol", "Curso de Beisbol"));
        items.add(new ItemsList(R.drawable.karate, "Karate", "Curso de Karate"));
        items.add(new ItemsList(R.drawable.voleibol, "Voleibol", "Curso de Voleibol"));
